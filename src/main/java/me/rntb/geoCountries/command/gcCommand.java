...
public class gcCommand implements TabExecutor { // TabExecutor includes onCommand method
    ...
    public static void registerSubCommands() {
        registerSubCommand("help", new gcHelpCommand("/gc help", "gc.help", true));
        registerSubCommand("purge", new gcPurgeCommand("/gc purge", "gc.purge", true));
        registerSubCommand("dump", new gcDumpCommand("/gc dump", "gc.dump", true));
        registerSubCommand("country", new gcCountryCommand("/gc country", "gc.country", true));
        registerSubCommand("player", new gcPlayerCommand("/gc player", "gc.player", true));
    ...
    public List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        // /gc [subcommand]
        if (args.length == 1) {
            return GetAllowedSubCommandsAsStrings((Player) sender);
        }
