...
public class gcCitizenshipAccept extends GeoCommand {
    ...
    public gcCitizenshipAccept(String name, String requiredPermission, ItemStack menuButtonItem) {
        super(name, requiredPermission, menuButtonItem);
        setHelpString("Accepts a player's citizenship application to your country.");
    }
    ...
    public void onCommand(CommandSender sender, String[] args) {
        ...
        ChatUtil.broadcastPrefixedMessageToCountry(country, "§f" + playerProfile.getUsername() + "§6 is now a citizen of §f" + country.getName() + "§6!", false);
    }
